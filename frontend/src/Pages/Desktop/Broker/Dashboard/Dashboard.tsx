...
function Dashboard(): JSX.Element {
  ...
  const [bikeFormPageStatus, setBikePageStatus] = React.useState(1);
            ...
            <Box className="modalInner md-width">
              <Grid container spacing={3}>
                <Grid item xs={12}>
                  ...
                  />
                  <h5 className="popup-heading">Bike Insurance - DL12BE3454</h5>
                </Grid>
              </Grid>
              <Grid container spacing={2} justifyContent="center">
                <Grid item xs={6} className="mb-3">
        ...
        <Box>
          <Grid container spacing={3}>
            ...
            <Grid item xs={7} className="text-right">
              ...
              <Link href="#" underline="none" className="greenBtn mail">
                {" "}
          ...
          <Grid container spacing={3}>
            ...
            <Grid item md={6} lg={4}>
              <button
                ...
                onClick={() => setCarPopupStatus(true)}
              >
                Car
              </button>
            </Grid>
            <Grid item md={6} lg={4}>
              <button
                ...
                onClick={() => setBikePopupStatus(true)}
              >
                Bike
              </button>
            </Grid>
